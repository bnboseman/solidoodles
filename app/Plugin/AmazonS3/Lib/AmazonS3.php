 ...
 * @author Rob Mcvey
 **/
	public function put($localPath , $name = null, $remoteDir = null) {
		// Base filename
		...
		$this->checkFile($file);
		$this->checkRemoteDir($remoteDir, $name);
 ...
 * @author Rob Mcvey
 **/
	public function checkRemoteDir($remoteDir, $name = null) {
