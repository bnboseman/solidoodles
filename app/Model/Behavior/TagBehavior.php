...
class TagBehavior extends ModelBehavior {
     ...
     */
     ...
     function beforeSave(Model $model, $options = array() ) {
    	$model_name = Inflector::singularize( $this->settings[$model->name]['table_label']);
    	
    	if (!isset($model->data[ $model->name][$this->settings[$model->name]['table_label'] ] ) ) return true;
